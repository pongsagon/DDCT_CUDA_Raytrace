...
public:
    ...
    __device__ virtual void set_color(vec3 color) {}
};


class lambertian : public material {
public:
    __device__ lambertian(const color& albedo) : tex(texture(albedo)){}
...
public:
    ...
    __device__ virtual void set_color(vec3 color) override
    {
        albedo += color;
    }
...
public:
    ...
    __device__ diffuse_light(const color& emit) : tex(texture(emit)) {}
