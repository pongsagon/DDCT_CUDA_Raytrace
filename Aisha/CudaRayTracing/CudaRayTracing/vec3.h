...
public:
    ...
    __host__ __device__ void setX(float val) { e[0] = val; }
    __host__ __device__ void setY(float val) { e[1] = val; }
    __host__ __device__ void setZ(float val) { e[2] = val; }
...
__host__ __device__ inline bool operator==(const vec3& v1, const vec3& v2) {
    ...
    return (fabs(v1.e[0] - v2.e[0]) < epsilon &&
        fabs(v1.e[1] - v2.e[1]) < epsilon &&
        fabs(v1.e[2] - v2.e[2]) < epsilon);
}
